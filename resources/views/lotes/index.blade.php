            ...
            <div class="items items-header-section">
                <div class="item-content">
                    ...
                    <div class="user-email col-md-3">
                        <h4 style="margin-left: 0;">Inicio/Fin</h4>
                    </div>
                    <div class="user-email col-md-3">
                        <h4 style="margin-left: 0;">Linea</h4>
                    </div>
            ...
            <div class="items">
                <div class="item-content">
                        ...
                        <div class="user-profile col-md-4"> 
                            <a href=" {{ route('lotes.show', $row->id) }}">
                            <div class="user-meta-info">
                                <p class="user-name"  data-name="{{  $row->lote_id }}" ># {{  $row->id }}</p>
                                <p class="user-work"  data-occupation="" > {{  $row->name }}</p>
                            </div></a>
                        </div>
                    ...
                    <div class="user-meta-info col-md-3">
                        <p class="user-name" style="color: green;"> {{  $row->start }}</p>
                            <p class="user-work" style="color:red;">  {{  $row->end }}</p>
                        </div>
                        <div class="user-meta-info col-md-3">
                            <p class="user-name" >
                                @if($row->product_id=='1')
