...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="compactSidebar">
        ...
        <div class="theme-logo">
            <a href="#">
                <img src="{{ url('/images/o.svg') }}" class="navbar-logo" alt="logo">
            </a>
        </div>
        ...
        <ul class="menu-categories">
            ...
            <li class="menu menu-single">
                <a href="{{url('loteprod')}}" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Lotes Prod.</span></div>
            </li>
            <li class="menu  menu-single">
                <a href="{{url('postura')}}" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Postura</span></div>
            </li>
            <li class="menu  menu-single">
                <a href="{{url('granjas')}}" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path xmlns="http://www.w3.org/2000/svg" d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path xmlns="http://www.w3.org/2000/svg" d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>
                        </div>
                    </div>
                </a>
                <div class="tooltip"><span>Reporte</span></div>
            </li>
            <li class="menu  menu-single border-primary " style="">
                <a href="{{url('qr')}}" data-active="qr" class="menu-toggle">
                    <div class="base-menu ">
                        <div class="base-icons text-dark">
                            <i class="far fa-qrcode"></i>
                        </div>
                    </div>
                </a>
                <div class="tooltip"><span>Escaneo QR</span></div>
            </li>
        ...
        <div class="sidebar-bottom-actions">
            ...
            <div class="external-links">
                <a target="_blank" href="{{ url('/info')}}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                    ...
                    <div class="dropdown-inner">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                @if (auth()->user()->image)
                                <img src="storage/.{{ auth()->user()->image }}" class="img-fluid mr-2 border border-dark">
                                @endif
