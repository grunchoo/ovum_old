                            ...
                            <li class="nav-item">
                                <div class="nav-link list-actions" id="invoice-{{ $item->id}}" data-invoice-id="{{ $item->id}}">
                                    <div class="f-m-body">
                                        ...
                                        <div class="f-body">
                                            @if ($item->id==0)
                                            <p class="invoice-number text-danger">Sin Asignar Nacimiento</p>
                ...
                <div class="invoice-inbox">
                    ...
                    <div id="ct"  >
                        ...
                        <div class="invoice-{{ $item->production_order_id }}">
                            ...
                            <div class="d-flex justify-content-between "  style="padding-left: 0em; padding-right: 0em; border-bottom: 0.5px solid #191e3a;">
                            @elseif ($item->status =='Despachado') 
                            <div class="d-flex justify-content-between align-items-center text-warning"  style="padding-left: 0em; padding-right: 0em; border-bottom: 0.5px solid #191e3a;">
                            @elseif ($item->status =='Entregado') 
                            <div class="d-flex justify-content-between align-items-center text-success"  style="padding-left: 0em; padding-right: 0em; border-bottom: 0.5px solid #191e3a;">
                            @elseif ($item->status =='Cancelado') 
                            <div class="d-flex justify-content-between align-items-center text-danger"  style="padding-left: 0em; padding-right: 0em; border-bottom: 0.5px solid #191e3a;">
                            @endif
                                            ...
                                            <div class="p-2" style="width: 250px;"> 
                                                <a href=" {{ route('orders.show', $item->id) }}">
                                                    ...
                                                    <p class="user-name mb-0" style="max-width: 248px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" >{{  $item->customer->name }}</p>
                                                    <p class="text-muted mb-0"> {{  $item->id }} -<i class="far fa-calendar-check"></i> {{ Carbon\Carbon::parse($item->fecha_entrega)->format('d/m/Y') }}</p>
                                                    @if ($item->status =='Nuevo') 
                                                    <p class="badge badge-primary mb-0" >Nuevo</p>
                                                    @elseif ($item->status =='Despachado') 
