...
<div class="col-md-12 col-sm-12 col-12">
    <div class="d-flex justify-content-between">
        ...
        <div class="task-action">
            ...
            data-target="#CreateModal" class="btn btn-primary btn-sm" style="margin-right:10px;"><i class="fa fa-2x fa-qrcode"></i></a>
            <a href="javascript:;" data-toggle="modal" onclick="createData()" 
            data-target="#CreateModal" class="btn btn-primary btn-sm" style="margin-right:10px;"><i class="fa fa-2x fa-plus"></i> </a>
        ...
        <div class="widget-content widget-content-area  ">
            <div class="table-responsive ">
                <table id="default-ordering" class="table table-hover" style="width:100%">
                    ...
                    <tbody>
                        @foreach($postura as $row)
                        
                        <tr style="border-bottom: 1px; ">
                            
                            <td class="p-2" >{{ $row->loteprod->lote }}</td>
                            <td class="p-2" style="max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"> {{$row->loteprod->supplier->name }} | {{ $row->loteprod->product->short}}</td>
                            <td class="p-2">{{ $row->incub }}</td>
                            <td class="p-2" style="max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $row->total}}</td>
                            <td class="p-2">{{ $row->mort_h }}</td>
                            
                            
                            <td class="btn-group p-2"  >
                                <a href=" {{ route('postura.show', $row->id) }}" class="btn btn-primary btn-sm p-1"><i class="fad fa-eye"></i></a>
